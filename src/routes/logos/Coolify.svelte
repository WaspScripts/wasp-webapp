<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 512 512" class="my-auto h-6">
	<path
		d="M48.2-177.1h-90.9V95.6h90.9zm0 363.6h363.7V95.6H48.2zm0-363.6h363.7V-268H48.2z"
		style="fill: #8c52ff; fill-opacity: 0.502"
...
<span class="mx-2 my-auto text-xl font-bold">Coolify</span>
