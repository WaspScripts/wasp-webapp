<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 203" class="my-auto h-6">
	<path
		id="logosZod1"
		fill="#000"
	...
	<g transform="translate(2 1.51)">
		...
		/>
		<use filter="url(#logosZod0)" href="#logosZod1" /><use fill="#3068B7" href="#logosZod1" /></g
	>
</svg>

<span class="mx-2 my-auto text-xl font-bold">Zod</span>
